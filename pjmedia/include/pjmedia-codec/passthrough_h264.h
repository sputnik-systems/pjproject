 ...
 */
#ifndef __PJMEDIA_CODEC_PASSTHROUGH_H264_H__
#define __PJMEDIA_CODEC_PASSTHROUGH_H264_H__
 ...
 */
PJ_DECL(pj_status_t) pjmedia_codec_passthrough_h264_vid_init(pjmedia_vid_codec_mgr *mgr,
                                                     pj_pool_factory *pf);
 ...
 * @return          PJ_SUCCESS on success.
 */
PJ_DECL(pj_status_t) pjmedia_codec_passthrough_h264_vid_deinit(void);
...
#endif  /* __PJMEDIA_CODEC_PASSTHROUGH_H264_H__ */
